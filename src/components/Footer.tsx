...
const Footer = () => {
  return (
    <footer className="w-full max-w-screen-sm md:max-w-screen-md mx-auto px-4 my-4 text-lg flex justify-between items-center">
      <p>Email: sahel[dot]iqbal[at]aalto[dot]fi</p>
